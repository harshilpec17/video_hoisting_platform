...
const VideoDetailPage = () => {
  ...
  //       dispatch(setWatchVideo(response.data.data[0]));
  //     }
  //   } catch (error) {
  ...
  const userName = useSelector(
    (state) => state.video?.newVideo?.owner[0]?.userName
  );
  ...
  const getChannelStatus = async () => {
    try {
      ...
      if (resposne.status === 200) {
        setChannelData(resposne.data.data);
        setIsSubscribed(resposne.data.data.isSubscribed);
        console.log("Channel Data:", resposne.data.data);
      }
    } catch (error) {
                  ...
                  <div>
                    <div className="flex gap-x-4">
                      ...
                      <div className="block">
                        ...
                        <p className="mt-3 text-sm">
                          Render props have always been a bit tricky htmlFor me.
                          Can&#x27;t wait to see how this series breaks it down.
                          Thanks htmlFor sharing!
                        </p>
                      </div>
                    </div>
                    <hr className="my-4 border-white" />
                    ...
                    <div className="flex gap-x-4">
                      ...
                      <div className="block">
                        ...
                        <p className="mt-3 text-sm">
                          ...
                          htmlFor far too long. Looking forward to demystifying
                  ...
                  <div>
                    <div className="flex gap-x-4">
                      ...
                      <div className="block">
                        ...
                        <p className="mt-3 text-sm">
                          Compound components are a game-changer htmlFor UI
                    ...
                    <div className="flex gap-x-4">
                      ...
                      <div className="block">
                        ...
                        <p className="mt-3 text-sm">
                          ...
                          topic has always confused me. Thanks htmlFor breaking
                          it down!
                        </p>
                      </div>
                    </div>
                  ...
                  <div>
                    <div className="flex gap-x-4">
                      ...
                      <div className="block">
                        ...
                        <p className="mt-3 text-sm">
                          This series is a goldmine htmlFor React developers!
                          Compound components are something I&#x27;ve been eager
                          to master. Thanks htmlFor this!
                        </p>
                      </div>
                    </div>
                    <hr className="my-4 border-white" />
                    ...
                    <div className="flex gap-x-4">
                      ...
                      <div className="block">
                        ...
                        <p className="mt-3 text-sm">
                          ...
                          components. Thanks htmlFor sharing!
                        </p>
                      </div>
                    </div>
                    <hr className="my-4 border-white" />
